 ...
 */
import { EmbedNoteItemInFeedItemProps } from '@company/note';
...
export function NoteEmbedCard({ feed, item }: EmbedNoteItemInFeedItemProps) {
...
NoteEmbedCard.displayName = 'NoteEmbedCard';

export default connectItemView(NoteEmbedCard, actionCreators);
