...
import { connectItemView, Link, useGlobal } from '@metafox/core';
...
// types
import { BlogItemProps as ItemProps } from '../../../types';
...
export function BlogItemMainCard({
  item,
  user,
  identity,
  state,
...
BlogItemMainCard.LoadingSkeleton = LoadingSkeleton;

export default connectItemView(BlogItemMainCard, actionCreators);
