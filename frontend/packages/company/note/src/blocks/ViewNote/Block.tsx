/**
 * @type: block
 * name: note.block.blogView
 * title: Note Detail
 * keywords: note
 * description: Display note detail
 */

import { BlogDetailViewProps as Props } from '@company/note';
import actionCreators from '@company/note/actions/blogItemActions';
import { BlogDetailViewProps as ItemProps } from '@company/note/types';
import {
  connectItemView,
  connectSubject,
  createBlock,
      ...
      <BlockContent>
        <div className={classes.root}>
            ...
            <Box sx={{ p: [2, 2, 0, 2] }}>
              ...
              >
                <Typography variant="body1" color="text.secondary">
                  {i18n.formatMessage({ id: 'blog_is_waiting_approve' })}
                </Typography>
                <Box sx={{ display: 'flex' }}>
                  <div
          ...
          >
            ...
            <Box component="div" mt={3} className={classes.blogContent}>
